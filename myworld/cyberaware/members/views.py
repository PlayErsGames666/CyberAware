    ...
    categories = [
        {
            ...
            "icon": "book",
            "items": [
                {"code": "first_step", "title": "First Step", "description": "read first lecture"},
                {"code": "start_of_journey", "title": "Start of Journey", "description": "completed first module entirely"},
                {"code": "curious", "title": "Curious", "description": "read 5 lectures"},
                {"code": "deep_dive", "title": "Deep Dive", "description": "read 10 lectures"},
                {"code": "to_the_end", "title": "To the End", "description": "finished lecture to 100%"},
                {"code": "no_skips", "title": "No Skips", "description": "completed module without skips"},
            ],
        },
        {
            "id": "tests",
            ...
            "icon": "check",
            "items": [
                {"code": "first_quiz", "title": "Knowledge Check", "description": "passed first test"},
                {"code": "no_mistakes", "title": "Passed on First Try", "description": "test completed without errors"},
                {"code": "almost_perfect", "title": "Almost Perfect", "description": "80%+ score"},
                {"code": "excellent", "title": "Excellent", "description": "100% on test"},
                {"code": "dont_give_up", "title": "Never Give Up", "description": "retook test after failure"},
                {"code": "all_quizzes", "title": "Material Mastered", "description": "passed all module tests"},
            ],
        },
        {
            "id": "cyber",
            ...
            "icon": "shield",
            "items": [
                {"code": "passwords", "title": "Password Protected", "description": "studied password security"},
                {"code": "phishing", "title": "Phishing? Not Today", "description": "completed phishing lecture"},
                {"code": "social_engineering", "title": "Trust but Verify", "description": "social engineering topic"},
                {"code": "hygiene", "title": "Digital Hygiene", "description": "learned basic security rules"},
                {"code": "safe_start", "title": "Safe Start", "description": "completed introductory course"},
            ],
        },
        {
            "id": "activity",
            ...
            "icon": "flame",
            "items": [
                {"code": "streak_2", "title": "Coming Back", "description": "logged in 2 days in a row"},
                {"code": "streak_5", "title": "Habit", "description": "5 days in a row"},
                {"code": "streak_7", "title": "Week with Us", "description": "7 days in a row"},
                {"code": "streak_14", "title": "Consistency", "description": "14 days in a row"},
            ],
        },
        {
            "id": "progress",
            ...
            "icon": "level",
            "items": [
                {"code": "level_2", "title": "First Level", "description": "reached level 2"},
                {"code": "level_5", "title": "Growing", "description": "reached level 5"},
                {"code": "xp_100", "title": "Experience Matters", "description": "100 XP"},
                {"code": "xp_500", "title": "Experienced", "description": "500 XP"},
                {"code": "xp_1000", "title": "Learning Veteran", "description": "1000 XP"},
            ],
        },
        {
            "id": "completion",
            ...
            "icon": "flag",
            "items": [
                {"code": "finish_course", "title": "Finish", "description": "completed course"},
                {"code": "all_modules", "title": "Informed User", "description": "completed all modules"},
                {"code": "cyberaware", "title": "CyberAware", "description": "unlocked all basic topics"},
            ],
        },
    ]
